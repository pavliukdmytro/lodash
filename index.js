class Lodash {
	...
	sortedLastIndex() {
		return require('./methods/sortedLastIndex/sortedLastIndex').apply(null, arguments);
	}
	sortedLastIndexBy() {
		return require('./methods/sortedLastIndexBy/sortedLastIndexBy').apply(null, arguments);
	}
	sortedLastIndexOf() {
	...
	flatMapDeep() {
		return require('./methods/flatMapDeep/flatMapDeep').apply(null, arguments);
	}
	flatMapDepth() {
		return require('./methods/flatMapDepth/flatMapDepth').apply(null, arguments);
	}
	groupBy() {
